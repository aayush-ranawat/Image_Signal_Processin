...
# comment or uncomment these to see result for given img set or camera set.

#######------------------------------------#################

img_1 , img_2 , img_3 = cv2.imread(r"camera/set_1/img_1.jpg") , cv2.imread(r"camera/set_1/img_2.jpg") ,cv2.imread(r"camera/set_1/img_3.jpg")

# img_1 , img_2 , img_3 = cv2.imread(r"camera/set_2/img_1.jpg") , cv2.imread(r"camera/set_2/img_2.jpg") ,cv2.imread(r"camera/set_2/img_3.jpg")
